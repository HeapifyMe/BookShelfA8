...
//        books();
    context=getActivity();
        ...
        search=sharedPreferencesClass.getSearch();
        if (sharedPreferencesClass.getPosition()==0) {
            if (!search.equals("")) {
                booksArray.clear();
                edEdit.setText(search);
                new SendRequest().execute();
                sharedPreferencesClass.setPosition(1);
            }
        }
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharedPreferencesClass.setSearch(search);
                new SendRequest().execute();
//                sharedPreferencesClass.setPosition(0);
